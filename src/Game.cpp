...
void Game::setupSDL() {
  ...
  // Create window
  m_SDLWindow = Window(SDL_CreateWindow("athena", SDL_WINDOWPOS_UNDEFINED,
  ...
  m_SDLRenderer = Renderer(SDL_CreateRenderer(m_SDLWindow, -1, SDL_RENDERER_ACCELERATED));
...
void Game::handleKey(int SDLKey) {
  switch (SDLKey) {
